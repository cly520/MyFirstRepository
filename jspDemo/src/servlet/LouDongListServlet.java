...
public class LouDongListServlet extends HttpServlet {
...
//        当前页码
        ...
        Page<Emp> page = userService.selectLouDong(params);
        request.setAttribute("page",page);
        request.setAttribute("ename",qname);
        request.setAttribute("loudong","".equals(loudong) ? null : loudong);
        request.getRequestDispatcher("pages/loudonglist.jsp").forward(request,response);
    }
}
